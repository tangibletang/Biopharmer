...
> **Evaluating the multi-agent system?** See [SUBMISSION.md](SUBMISSION.md) for how the Research Barn answers the Option A brief—agent roles, tools, human-in-the-loop controls, and code pointers.
